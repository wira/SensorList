...
public class SensorListActivity extends FragmentActivity implements
	 ...
	 * the item with the given type was selected.
	 */
	@Override
	public void onItemSelected(String type) {
		if (mTwoPane) {
			...
			arguments.putString(SensorDetailFragment.ARG_SENSOR_TYPE, type);
			...
			detailIntent.putExtra(SensorDetailFragment.ARG_SENSOR_TYPE, type);
